...
هر 1 دقیقه فعالیت سلف برابر با 1 جم مصرف است.
...
موجودی حساب شما به‌ صورت خودکار از مقدار جم مصرف‌ شده کسر میشود.
...
در صورت کاهش موجودی سیستم به شما هشدار میدهد.
...
پس از تأیید پرداخت مقدار جم خریداری‌ شده به موجودی حساب شما اضافه میشود و میتوانید از آن برای فعال نگه‌ داشتن سرویس استفاده کنید.

─────━━───── ◈ ─────━━─────

نکته :
مدت قابل استفاده به میزان مصرف سلف بستگی دارد فعال بودن مداوم سلف باعث مصرف مداوم جم میشود.""",
                {"inline_keyboard": [

...
function authBody(){
 ...
 return `<div class="success"><div class="success-ring">✓</div><div class="eyebrow">SYSTEM READY</div><h1>${state.lang==="fa"?"حساب متصل شد":"ACCOUNT CONNECTED"}</h1><p class="lede">${state.lang==="fa"?"احراز هویت با موفقیت انجام شد.":"Authentication completed successfully."}</p><button class="secondary-button" id="reset">SALF1 COMMAND CENTER →</button></div>`;
}

function render(){
 document.documentElement.lang=state.lang;document.documentElement.dir=state.lang==="fa"?"rtl":"ltr";
 app.innerHTML=`<main class="scene"><canvas id="space"></canvas><div class="vignette"></div><div class="ambient a"></div><div class="ambient b"></div>
<header class="topbar"><div class="brand-lockup"><div class="brand-mark"><img src="/brand/panther-mark.svg" alt="SALF1"/></div><div class="brand-copy"><strong>SALF1</strong><span>${t("brand")}</span></div></div><div class="actions"><div class="online"><i></i> CONNECTED</div><button class="language" id="language">${t("language")}</button></div></header>
<section class="hero"><div class="auth-col"><div class="auth-card"><div class="topline"><span>${t("system")}</span><span>01 / 01</span></div><div class="auth-logo"><div class="s1">S<span>1</span></div><div><strong>SALF1</strong><small>${t("micro")}</small></div></div><div id="auth">${authBody()}</div><footer><span>● SECURE SYSTEM</span><span>ENCRYPTED SESSION</span></footer></div></div>
<div class="panther-col"><div class="orbit orbit1"></div><div class="orbit orbit2"></div><div class="bloom"></div><div class="panther" id="panther"><div class="shadow"></div><img src="/brand/panther-mark.svg" alt="Black Panther"/></div><div class="panther-label"><span></span><div>SALF1 / PANTHER<strong>PRIVATE ACCESS</strong></div></div></div></section>
<footer class="hud"><span>01 AUTH</span><span>02 SESSION</span><span>03 SECURE</span><span>© SALF1</span></footer></main>`;
